...
import com.wechat.template.service.trojan.UkUsersService;
...
@DS("slave_uk")
@Service
public class UkUsersServiceImpl extends ServiceImpl<UsersTrojan, Users> implements UkUsersService {
